...
DROP FUNCTION IF EXISTS public.intasend_mpesa_fund_wallet(uuid, varchar, numeric);
DROP FUNCTION IF EXISTS public.intasend_mpesa_fund_wallet(uuid, text, numeric);
DROP FUNCTION IF EXISTS public.intasend_mpesa_fund_wallet(uuid, varchar(15), decimal(15,2));

-- Create function with correct parameter names that match frontend
