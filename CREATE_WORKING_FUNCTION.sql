-- Create function with a completely different name to bypass cache
CREATE OR REPLACE FUNCTION public.mpesa_fund_wallet(
  wallet_id UUID,
  phone_number TEXT,
  amount NUMERIC
)
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.mpesa_fund_wallet(UUID, TEXT, NUMERIC) TO authenticated;
GRANT EXECUTE ON FUNCTION public.mpesa_fund_wallet(UUID, TEXT, NUMERIC) TO anon;