-- Deploy All Required Functions for IntaSend Integration
-- Run this entire script in your Supabase SQL Editor

-- First, make sure we have the updated_at trigger function
...
-- Function to initiate M-Pesa funding (FIXED VERSION)
...
BEGIN
  ...
  WHERE id = p_from_wallet_id AND user_id = v_from_user_id;
